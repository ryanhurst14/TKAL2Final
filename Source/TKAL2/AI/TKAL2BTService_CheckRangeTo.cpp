...
#include "TKAL2BTService_CheckRangeTo.h"

#include "AIController.h"
#include "../../../Intermediate/ProjectFiles/TKAL2GameTypes.h"
#include "BehaviorTree/BlackboardComponent.h"

void UTKAL2BTService_CheckRangeTo::TickNode(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory, float DeltaSeconds)
{
...
UTKAL2BTService_CheckRangeTo::UTKAL2BTService_CheckRangeTo()
{
